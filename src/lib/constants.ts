...
// Windows（.exe / NSIS）— GitHub Actions でビルドし、Mac と同じ Drive「Comet」フォルダに配置
export const DRIVE_EXE_URL = 'https://drive.google.com/file/d/1z7HorLTr3SCFkptbtoLvTgw5DwesqAow/view'
export const EXE_FILENAME = 'Comet-Setup-0.1.0.exe'
export const EXE_SIZE_LABEL = '約97MB'
